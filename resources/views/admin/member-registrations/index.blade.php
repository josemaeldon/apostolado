                        ...
                        <form action="{{ route('admin.member-registrations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="parish" id="create_parish" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                                ...
                                <div>
                                    ...
                                    <select name="member_city" id="create_member_city" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                                ...
                                <div>
                                    ...
                                    <select name="member_parish" id="create_member_parish" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
                                        <option value="">Selecione uma paroquia...</option>
