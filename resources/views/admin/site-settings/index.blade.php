        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Configure o nome, logo, e footer do seu site.
                </p>
            </div>
                ...
                <form id="settings-form" action="{{ route('admin.site-settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4">Configurações do Footer</h3>
                            <p class="text-sm text-gray-600 mb-6">
                                Configure as informações exibidas no rodapé do site.
                            </p>
                            
                            <!-- Footer Title (Apostolado da Oração) -->
                            <div class="mb-6">
                                ...
                                <input 
                                    ...
                                    name="footer_title" 
                                    id="footer_title" 
                                    value="{{ old('footer_title', $footerTitle) }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    placeholder="Apostolado da Oração"
                                    required
                                >
                                <p class="mt-1 text-sm text-gray-500">
                                    Título principal do footer (primeira coluna).
                                </p>
                                @error('footer_title')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-6">
                                ...
                                <textarea 
                                    ...
                                    rows="3"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    placeholder="Rede Mundial de Oração do Papa"
                                    required
                            ...
                            <div class="mb-6">
                                ...
                                <input 
                                    ...
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    placeholder="contato@apostoladodaoracao.org.br"
                                    required
                                >
                                <p class="mt-1 text-sm text-gray-500">
                                    Email exibido na seção de contato do footer.
                                </p>
                                @error('footer_email')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                >
                                <p class="mt-1 text-sm text-gray-500">
                                    Telefone exibido na seção de contato do footer.
                                </p>
                                @error('footer_phone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
