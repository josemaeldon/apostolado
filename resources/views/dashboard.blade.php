                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                            <div class="text-4xl mr-4">🗄️</div>
                            <div>
                                <h4 class="text-lg font-semibold text-gray-800">{{ __('auth-custom.storage_settings') }}</h4>
                            </div>
                        </div>
                        <p class="text-gray-600 mb-4 text-sm">{{ __('auth-custom.storage_settings_desc') }}</p>
                        <a href="{{ route('admin.storage-settings.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            {{ __('auth-custom.configure') }}
                        </a>
                    </div>
                </div>
