...
<body class="font-sans antialiased bg-neutral-50">
    ...
    @php
        $heroImageUrl = $prayerIntention->image ? \App\Helpers\ImageHelper::storageUrl($prayerIntention->image) : null;
    @endphp
    ...
    <div class="relative py-16 overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-primary-100 font-semibold mb-3">Intenções de Oração</p>
